...
var _newsPortals = __webpack_require__(331);

var _newsPortals2 = _interopRequireDefault(_newsPortals);

var _portalItem = __webpack_require__(332);

var _portalItem2 = _interopRequireDefault(_portalItem);

var _articlesManager = __webpack_require__(333);

var _articlesManager2 = _interopRequireDefault(_articlesManager);
...
(function () {
    document.addEventListener("DOMContentLoaded", function () {
        // Local variables
        var articleManager = new _articlesManager2.default(document.querySelector('.greeting'), document.querySelector('.loading'));
        var aside = document.getElementById('aside');
        var currentFilter = 'all';
        var currentPortal = null;

        _newsPortals2.default.map(function (item) {
            return new _portalItem2.default(item.title, item.newsId, item.logoUrl).getHTMLElement;
        }).forEach(function (item) {
            return aside.appendChild(item);
        });
        ...
        aside.addEventListener('click', function (event) {
            ...
            var _articleManager$loadA = articleManager.loadArticles(currentPortal, currentFilter, item.id, currentFilter);

            var _articleManager$loadA2 = _slicedToArray(_articleManager$loadA, 2);

            currentPortal = _articleManager$loadA2[0];
            currentFilter = _articleManager$loadA2[1];
        });
        ...
        document.getElementsByTagName('nav')[0].addEventListener('click', function (event) {
            ...
            var _articleManager$loadA3 = articleManager.loadArticles(currentPortal, currentFilter, currentPortal, item.getAttribute('for'));

            var _articleManager$loadA4 = _slicedToArray(_articleManager$loadA3, 2);

            currentPortal = _articleManager$loadA4[0];
            currentFilter = _articleManager$loadA4[1];
        });
    });
})();
...
exports.default = [{
    ...
    title: 'CNN',
    newsId: 'cnn',
    logoUrl: 'http://cdn.cnn.com/cnn/.e/img/3.0/global/misc/apple-touch-icon.png'
}, {
    title: 'Financial Times',
    newsId: 'financial-times',
    logoUrl: 'https://www.ft.com/__origami/service/image/v2/images/raw/ftlogo-v1%3Abrand-ft-logo-square-coloured?source=update-logos&width=180&height=180&format=png'
}, {
    title: 'Independent',
    newsId: 'independent',
    logoUrl: 'http://www.independent.co.uk/sites/all/themes/ines_themes/independent_theme/img/apple-icon-120x120.png'
}, {
    title: 'Bloomberg ',
    newsId: 'bloomberg',
    logoUrl: 'https://assets.bwbx.io/business/public/images/favicons/apple-touch-icon-120x120-ef3226f2bd.png'
}, {
    title: 'BBC Sport',
    newsId: 'bbc-sport',
    logoUrl: 'https://icons.better-idea.org/lettericons/B-120-3091b8.png'
}, {
    title: 'Daily Mail',
    newsId: 'daily-mail',
    logoUrl: 'http://www.dailymail.co.uk/apple-touch-icon.png'
}, {
    title: 'Google News (Russia)',
    newsId: 'google-news-ru',
    logoUrl: 'https://ssl.gstatic.com/news-static/img/1703439073-news-thumb-128_w.png'
}, {
    title: 'Hacker News',
    newsId: 'hacker-news',
    logoUrl: 'https://icons.better-idea.org/lettericons/Y-120-ff6600.png'
}, {
    title: 'Lenta',
    newsId: 'lenta',
    logoUrl: 'https://icdn.lenta.ru/lenta_touch.png'
}, {
    title: 'Metro',
    newsId: 'metro',
    logoUrl: 'http://1.gravatar.com/blavatar/72ba1fb4e57339685f67d1d89b3db216?s=120'
}, {
    title: 'MTV News',
    newsId: 'mtv-news',
    logoUrl: 'http://www.mtv.com/apple-touch-icon-precomposed.png'
}, {
    title: 'Polygon',
    newsId: 'polygon',
    logoUrl: 'https://cdn.vox-cdn.com/uploads/hub/sbnu_logo_minimal/405/touch_icon_ipad_retina_1000x1000.7014.png'
}, {
    title: 'Reuters',
    newsId: 'reuters',
    logoUrl: 'http://s1.reutersmedia.net/resources_v3/images/favicon/apple-touch-icon-120x120.png'
}, {
    title: 'The New York Times',
    newsId: 'the-new-york-times',
    logoUrl: 'https://mobile.nytimes.com/vi-assets/apple-touch-icon-319373aaf4524d94d38aa599c56b8655.png'
}];
...
var PortalItem = function () {
    function PortalItem(title, newsId, logoUrl) {
        _classCallCheck(this, PortalItem);
...
var _requestManager = __webpack_require__(334);
...
var ArticlesManager = function () {
    function ArticlesManager(greetingElement, infoBox) {
        _classCallCheck(this, ArticlesManager);
    ...
    _createClass(ArticlesManager, [{
        key: 'getArticleList',
        value: function getArticleList() {
        ...
        value: function getCurrentFilter() {
            var buttons = document.getElementsByName('articleType');
            buttons.find = [].find;
            return buttons.find(function (item) {
                return item.checked;
            }).id;
        }
    }, {
        key: 'hideGreetingElement',
        value: function hideGreetingElement() {
        ...
        key: 'loadArticles',
        value: function loadArticles(currentPortal, currentFilter, newsPortalId, filter) {
            var _this = this;
            ...
            _requestManager2.default.sendRequest(newsPortalId, currentFilter).then(function (data) {
                _this.toggleSpinner();
                data.map(function (item) {
                    return new _articleItem2.default(item).getHTMLElement;
                }).forEach(function (item) {
                    return _this.getArticleList().appendChild(item);
                });
...
exports.default = ArticlesManager;
...
var API_KEY = '0862223bc5834b99a8ab44f7ab2f375d';
var HTTPS_ADDRESS = 'https://newsapi.org/v2/';
var REQUEST_TYPE = {
    all: 'everything',
...
var RequestManager = function () {
    ...
    _createClass(RequestManager, null, [{
        key: 'getUrl',
        value: function getUrl(newsPortalId, filter) {
            return HTTPS_ADDRESS + REQUEST_TYPE[filter] + '?sources=' + newsPortalId + '&apiKey=' + API_KEY;
        }
    }, {
        key: 'sendRequest',
        value: function sendRequest(newsPortalId, filter) {
            var _this = this;

            return new Promise(function (resolve, reject) {
                fetch(_this.getUrl(newsPortalId, filter)).then(function (response) {
                    return response.json();
                }).then(function (data) {
                    return data.status !== RESPONSE_STATUS.ERROR ? resolve(data.articles) : reject(error);
                }).catch(function (error) {
                    return reject(error);
                });
            });
...
var Article = function () {
    ...
    _createClass(Article, [{
        ...
        key: 'createParagraph',
        value: function createParagraph(text) {
        ...
        key: 'createLinkToSource',
        value: function createLinkToSource() {
        ...
        value: function createFooter() {
            ...
            var time = new Date(Date.parse(this.publishedAt));
